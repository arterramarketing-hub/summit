...
- **Carving costs speed.** The board keeps what points forward and scrubs what
  does not, so turning across the fall line is your only brake — and your
  biggest liability.
...
- **Cans** sit in trails across the open snow and in ballistic arcs over every
  kicker, so the line that pays is the line with air on it. They chain, and each
  one loosens the drag for a few seconds.
